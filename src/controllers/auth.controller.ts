...
export async function forgot_password(req:any,res:any){res.json(await service.forgotPassword(req.body, req.params, req.query));}
export async function reset_password(req:any,res:any){res.json(await service.resetPassword(req.body, req.params, req.query));}
