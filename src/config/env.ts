...
export const env = {
  ...
  adminSeedPassword: getRequiredInProduction('ADMIN_SEED_PASSWORD', 'Test123!Drive'),
  testRiderSeedPassword: getString('TEST_RIDER_SEED_PASSWORD', 'Test123!Drive'),
  testDriverSeedPassword: getString('TEST_DRIVER_SEED_PASSWORD', 'Test123!Drive'),
