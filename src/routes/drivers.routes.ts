...
import { applySchema, availabilitySchema, documentsSchema, driverDispatchPreferencesSchema, locationSchema, vehicleCreateSchema, vehicleProfileSchema } from '../schemas/drivers.schemas';
...
router.post('/preferences', validateBody(driverDispatchPreferencesSchema), controller.updateDispatchPreferences);
...
router.get('/earnings/month', controller.earningsMonth);
router.get('/earnings/lifetime', controller.earningsLifetime);
router.get('/payout-connect/status', controller.connectPayoutStatus);
router.post('/payout-connect/onboarding', controller.connectPayoutOnboarding);
router.post('/payout-connect/dashboard', controller.connectPayoutDashboard);
router.get('/wallet', controller.wallet);
router.get('/transactions', controller.transactions);
router.post('/wallet/withdraw', controller.walletWithdraw);
